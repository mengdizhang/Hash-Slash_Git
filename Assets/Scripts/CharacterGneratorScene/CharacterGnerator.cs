...
public class CharacterGnerator:MonoBehaviour
{
		...
		{
				Debug.Log ("CharacterGntViewMediator -> onViewIncreaseAttriBntClicked() called");
				if (points_left_ > 0) {
		...
		{
				Debug.Log ("CharacterGntViewMediator -> onViewDecreaseAttriBntClicked() called");
		...
		{
				Debug.Log ("CharacterGntViewMediator -> onViewCreateCharacterBntClicked() called");
